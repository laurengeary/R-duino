...
According to @7318608 ,during low intensity aerobic exercise, skin temperature over both active and inactive muscles decreases, returning to normal values  a few minutes after it. This finding is counterintuitive, because according to @sawka1993physiological, core temperature initially increases rapidly and subsequently increases at a reduced rate until heat loss equals heat production during exercise. We would like to investigate on the topic of whether body temperature vary in human subjects according to activity level?.
...
# Discussion
The results is consistent with the findings from the paper @731860 that the skin temperature decreases instead of increases after exercise. Our first hypothesis to explain the decrease in skin temperature is that the evaporating cooling is enhanced during exercise. Howver, according to @731860, fall in skin temperature during initial exercise was not due to increased evaporative cooling but to vasoconstriction, probably caused by non-thermal factors.
...
### Weihang Huang
Created the bibligrophy text file and modified the introduction wrote by Julia. Wrote the dicussion session.
